...
if __name__ == '__main__':
    ...
    data_path = f"{root_path}/data/person/trip_cose_user.txt"
    checkpoint_path = f"{root_path}/checkpoint/person"
    save_ckpt_path = f"{checkpoint_path}/kobert-person.pth"

    n_epoch = 30  # Num of Epoch
